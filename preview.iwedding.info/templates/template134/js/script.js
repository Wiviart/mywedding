                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if(!res.error){
                            ...
                            $('#show-comments').prepend('<div class="box-comment p-3 mx-2 mb-3"><h4 id="user-name-comment">'+$(form).find("input[name='name']").val().replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;")+'</h4><p id="comment-detail" class="m-0">'+$(form).find("textarea[name='content']").val().replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;")+'</p></div>');
